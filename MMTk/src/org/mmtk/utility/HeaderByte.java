...
public class HeaderByte {
  ...
  private static final int UNLOGGED_BIT_NUMBER = TOTAL_BITS - (NEEDS_UNLOGGED_BIT ? 1 : 0) - VM.objectModel.usedAvailableBits();
  public static final byte UNLOGGED_BIT = (byte) (1<<UNLOGGED_BIT_NUMBER);
  // Escape/race detector: steal from the available bits
