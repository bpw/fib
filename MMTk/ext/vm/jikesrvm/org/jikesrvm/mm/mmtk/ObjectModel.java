...
@Uninterruptible public final class ObjectModel extends org.mmtk.vm.ObjectModel implements org.mmtk.utility.Constants,
  ...
  // Escape and race detectors: Wrapper method for the config option.
  @Override
  public int usedAvailableBits() {
    // +1 for new array shadow scheme.
    return (Esc.getConfig().escapeUseOneBitInGCHeader() ? 1 : 0) + 1;
  }
}
