...
public class Object {
  ...
  protected Object clone() throws CloneNotSupportedException {
    ...
    // Octet: TODO: execute explicit read barrier here

    Object obj = RuntimeEntrypoints.clone(this);
  ...
  public final void wait() throws InterruptedException,
    ...
    RVMThread.wait(this, Magic.getStaticContext() == Context.APP_CONTEXT);
  }
  ...
  public final void wait(long time, int frac)  throws InterruptedException,
    ...
    if (time >= 0 && frac >= 0 && frac < 1000000) {
      ...
      if (time == 0) {
        ...
        RVMThread.wait(this, time, Magic.getStaticContext() == Context.APP_CONTEXT);
      }
    } else {
