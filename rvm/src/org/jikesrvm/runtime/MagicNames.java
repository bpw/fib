...
public class MagicNames {
  ...
  // Octet: Support compile-time introspection
  public static final Atom getSiteID = Atom.findOrCreateAsciiAtom("getSiteID");
  public static final Atom getStaticContext = Atom.findOrCreateAsciiAtom("getStaticContext");
