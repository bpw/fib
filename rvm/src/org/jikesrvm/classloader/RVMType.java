...
public abstract class RVMType extends AnnotatedElement
  ...
  /**
   * FIB: offsets of inlined access histories.
   */
  protected int[] drAccessHistoryOffsets;
  ...
  /**
   * FIB: Offsets of potentially reference-containing instance fields of this class type.
   * Offsets are with respect to object pointer -- see RVMField.getFibOffset().
   */
  @Uninterruptible
  @Inline
  public int[] getDrHistoryOffsets() {
    if (VM.VerifyAssertions) VM._assert(isResolved());
