...
public final class BC2IR
  ...
  /** Octet: Adding method to get the current bci (needed by Magic.getSiteID) */
      ...
      switch (code) {
        ...
        case JBC_invokevirtual: {
          ...
          if (ref.isMiranda()) {
            ...
            boolean unresolved = ref.needsDynamicLink(bcodes.getMethod());
            RVMMethod target = ref.peekResolvedMethod(gc.method.getStaticContext());
            ...
            if (type != null && type.isResolved()) {
              if (type.isClassType()) {
                ...
                if (target == null || type != target.getDeclaringClass()) {
                  vmeth = ClassLoaderProxy.lookupMethod(type.asClass(), ref, gc.method.getStaticContext());
                }
                if (vmeth != null) {
        ...
        case JBC_invokespecial: {
          MethodReference ref = bcodes.getMethodReference();
          RVMMethod target = ref.resolveInvokeSpecial(gc.method.getStaticContext());
        ...
        case JBC_invokeinterface: {
          ...
          resolvedMethod = ref.peekInterfaceMethod(gc.method.getStaticContext());
          ...
          if (requiresImplementsTest && resolvedMethod == null) {
            ...
            Instruction callCheck =
              Call.create3(CALL,
                           ...
                           receiver.copy(),
                           IRTools.IC(gc.method.getStaticContext()));
