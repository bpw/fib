...
import org.jikesrvm.compilers.opt.EscapeOptInstr;
...
public class OptimizationPlanner {
  ...
  private static void HIR2LIR(ArrayList<OptimizationPlanElement> p) {
    ...
    composeComponents(p, "Convert HIR to LIR", new Object[]{
        ...
        // Escape: add instrumentation early.
        // Man: It should be here because all instructions that need Octet barrier have been marked as possibleSharedMemoryAccess, and instructions in inlined DynEscape barrier will not be instrumented by Octet.
        new EscapeOptInstr(false),
