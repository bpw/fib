  ...
  public static Instruction callHelper(Instruction v, IR ir) {
    ...
    if (methOp.isStatic()) {
      ...
      if (VM.BuildForIMTInterfaceInvocation) {
        ...
        InterfaceMethodSignature sig = InterfaceMethodSignature.findOrCreate(methOp.getMemberRef(), v.position.method.getStaticContext());
        ...
        if (VM.BuildForITableInterfaceInvocation && methOp.hasTarget()) {
          ...
          itableIndex =
              InterfaceInvocation.getITableIndex(I,
                                                    ...
                                                    v.position.method.getStaticContext());
        }
        if (itableIndex == -1) {
          ...
          Instruction vp =
              Call.create3(CALL,
                           ...
                           IC(v.position.method.getStaticContext()));
