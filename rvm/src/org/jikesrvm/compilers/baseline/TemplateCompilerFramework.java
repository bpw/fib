    ...
    while (bcodes.hasMoreBytecodes()) {
      ...
      switch (code) {
        ...
        case JBC_invokevirtual: {
          ...
          if (methodRef.isMiranda()) {
            ...
            if (methodRef.needsDynamicLink(method)) {
              ...
              if (VM.VerifyUnint && !isInterruptible) checkTarget(methodRef.peekResolvedMethod(method.getStaticContext()), bcodes.index());
        ...
        case JBC_invokespecial: {
          ...
          RVMMethod target = methodRef.resolveInvokeSpecial(method.getStaticContext());
          if (target != null) {
