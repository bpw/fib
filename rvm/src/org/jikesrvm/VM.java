...
public class VM extends Properties implements Constants, ExitStatus {
  ...
  @NoInline
  public static void sysWriteln(int i, int j) {
    swLock();
    write(i);
    write(j);
    writeln();
  ...
  @NoInline
  public static void sysWriteln(String s1, String s2, ObjectReference r) {
    swLock();
    write(s1);
    write(s2);
    write(r);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, int i2) {
    swLock();
    write(s1);
    write(i1);
    write(i2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, double i2) {
    swLock();
    write(s1);
    write(i1);
    write(i2);
  ...
  @NoInline
  public static void sysWriteln(String s1, Word w1, String s2, Word w2, String s3, int i) {
    swLock();
    write(s1);
    write(w1);
    write(s2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, String s2, int i2, String s3, int i3, String s4, int i4) {
    swLock();
    write(s1);
    write(i1);
    write(s2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, String s2, int i2, String s3, int i3, String s4, String s5) {
    swLock();
    write(s1);
    write(i1);
    write(s2);
  ...
  @NoInline
  public static void sysWriteln(String s1, int i1, String s2, int i2, String s3, int i3, String s4, int i4, String s5, int i5) {
    swLock();
    write(s1);
    write(i1);
    write(s2);
  ...
  @NoInline
  public static void sysWrite(String s1, Word w1, String s2) {
    swLock();
    write(s1);
    write(w1);
    write(s2);
  ...
  @NoInline
  public static void sysWrite(String s1, Word w1, String s2, Word w2, String s3, int i1) {
    swLock();
    write(s1);
    write(w1);
    write(s2);
  ...
  @NoInline
  public static void tsysWriteln(String s1, Atom a) {
    swLock();
    showThread();
    write(s1);
    write(a);
